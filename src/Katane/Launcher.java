...
public class Launcher {
	...
	public static void gameConsole (Katane katane) {
		...
		do {
			...
			if (choice == 1) {
				System.out.println("Choisissez une coordonnée x pour installer votre route.\nSi vous tapez 42, vous aurez la liste de toutes les coordonnées vous pourrez construire vos routes.");
				x = scanner.nextInt();
				if (x == 42) {
					bmw.possibleRoadsBuild(P, W);
				} else {
					System.out.println("Choisissez une coordonnée y pour installer votre route.");
					y = scanner.nextInt();
					bmw.buildRoad(P, W, new Coordinates(x, y));
				}
			}
			if (choice == 2) {
				System.out.println("Choisissez une coordonnée x pour installer votre dolorean.x.");
				x = scanner.nextInt();
				System.out.println("Choisissez une coordonnée y pour installer votre route.");
				y = scanner.nextInt();
			...
			if (choice == 3) {
				System.out.println("Choisissez une coordonnée x pour installer votre TimeTown.");
				x = scanner.nextInt();
				System.out.println("Choisissez une coordonnée y pour installer votre route.");
				y = scanner.nextInt();
			...
			if (choice == 5) {
				System.out.println("1: Souhaitez avoir un exemple de l'application de la route la plus sur un grand échantillon de route.\n 2: L'appliquer à une de mes route");
				x = scanner.nextInt();
				if (x == 1) {
					cheatLongestRoad(katane);
				}
				if (x == 2) {
					System.out.println("Choisissez une coordonnée x pour démarrer l'algorithme");
					x = scanner.nextInt();
					System.out.println("Choisissez une coordonnée y pour démarrer l'algorithme");
					y = scanner.nextInt();
